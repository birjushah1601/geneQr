...
import { Brain, X, Loader2, AlertTriangle, Lightbulb, Package, TrendingUp } from "lucide-react";
...
interface AIDiagnosisModalProps {
  ...
  onAccept?: (diagnosis: any) => void;
  onReject?: (diagnosis: any) => void;
}
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
              ...
              {diagnosis[0] &&
                (() => {
                  ...
                  const confidenceColor =
                    latest.confidence_level === "HIGH"
                      ? "bg-green-100 text-green-800 border-green-300"
                      : latest.confidence_level === "MEDIUM"
                  ...
                  return (
                    <div className="space-y-6">
                      ...
                      {/* Vision Analysis */}
                      {latest.vision_analysis &&
                        latest.vision_analysis.findings &&
                        latest.vision_analysis.findings.length > 0 && (
        ...
        <div className="border-t px-6 py-4 bg-gray-50 flex justify-end gap-3">
          ...
          {diagnosis && diagnosis.length > 0 && onAccept && (
            <>
              <button
                onClick={() => onReject?.(diagnosis)}
                disabled={isLoading}
              ...
              <button
                onClick={() => onAccept?.(diagnosis)}
                disabled={isLoading}
                className="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors disabled:opacity-50 flex items-center gap-2"
              >
                ✅ Accept &amp; Add to Comments
              </button>
            </>
          )}
