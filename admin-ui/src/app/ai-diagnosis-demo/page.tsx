...
export default function AIDiagnosisDemoPage() {
  ...
  const handleDiagnosisAccept = async (diagnosisId: string) => {
    ...
    setFeedback('✅ Diagnosis accepted! AI learning improved.');
  };
  ...
  const handleDiagnosisReject = async (diagnosisId: string, feedbackText?: string) => {
    ...
    setFeedback('❌ Diagnosis rejected. Thank you for the feedback to improve our AI!');
  };
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg shadow-lg p-6 mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold">🤖 AI-Assisted Diagnosis Demo</h1>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
          <h2 className="text-xl font-semibold mb-4">🏥 Demo Equipment</h2>
        ...
        {/* Scenario Selector */}
        <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
          <h2 className="text-xl font-semibold mb-4">⚡ Select Issue Scenario</h2>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
          <h3 className="font-semibold text-blue-900 mb-3">🎯 How to Test the Demo</h3>
