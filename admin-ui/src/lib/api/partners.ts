...
class PartnersAPI {
  ...
  async listPartners(
    ...
    const url = `${API_BASE_URL}/organizations/${manufacturerId}/partners${params.toString() ? '?' + params.toString() : ''}`;
  ...
  async getAvailablePartners(
    ...
    const url = `${API_BASE_URL}/organizations/${manufacturerId}/available-partners${params.toString() ? '?' + params.toString() : ''}`;
  ...
  async associatePartner(
    ...
    const response = await fetch(`${API_BASE_URL}/organizations/${manufacturerId}/partners`, {
      method: 'POST',
      headers: this.getAuthHeaders(),
      body: JSON.stringify({
        ...data,
  ...
  async removePartner(
    ...
    const url = `${API_BASE_URL}/organizations/${manufacturerId}/partners/${partnerId}${params.toString() ? '?' + params.toString() : ''}`;
  ...
  async getNetworkEngineers(
    ...
    const url = `${API_BASE_URL}/engineers/network/${manufacturerId}${params.toString() ? '?' + params.toString() : ''}`;
