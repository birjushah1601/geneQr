...
$equipmentPayloads = @(
    @{ serial_number = "SN-ECG-0001"; equipment_name = "ECG Machine Pro"; manufacturer_name = "Wipro GE Healthcare"; model_number = "ECG-1000"; category = "ECG"; customer_name = "AIIMS New Delhi"; installation_location = "Cardiology OPD, Block A"; purchase_price = 250000; warranty_months = 12; created_by = $CreatedBy },
    @{ serial_number = "SN-VTL-0001"; equipment_name = "Ventilator Max"; manufacturer_name = "Siemens Healthineers India"; model_number = "VTL-500"; category = "Ventilator"; customer_name = "Apollo Hospitals Chennai"; installation_location = "ICU, Tower-1"; purchase_price = 850000; warranty_months = 24; created_by = $CreatedBy },
    @{ serial_number = "SN-INF-0001"; equipment_name = "Infusion Pump Lite"; manufacturer_name = "Philips Healthcare India"; model_number = "INF-200"; category = "Infusion Pump"; customer_name = "Fortis Hospital Mumbai"; installation_location = "Ward 3B"; purchase_price = 65000; warranty_months = 12; created_by = $CreatedBy },
    @{ serial_number = "SN-XRY-0001"; equipment_name = "X-Ray System Alpha"; manufacturer_name = "SouthCare Channel Partners"; model_number = "XR-900"; category = "X-Ray"; customer_name = "Manipal Hospitals Bengaluru"; installation_location = "Radiology Suite 2"; purchase_price = 420000; warranty_months = 18; created_by = $CreatedBy },
    @{ serial_number = "SN-CT-0001"; equipment_name = "CT Scanner Nova"; manufacturer_name = "Wipro GE Healthcare"; model_number = "CT-16S"; category = "CT"; customer_name = "Yashoda Hospitals Hyderabad"; installation_location = "Imaging Center"; purchase_price = 12500000; warranty_months = 12; created_by = $CreatedBy }
)
