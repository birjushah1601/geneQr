...
$equipmentPayloads = @(
    ...
    @{ serial_number = "SN-XRY-0001"; equipment_name = "X-Ray System Alpha"; manufacturer_name = "SouthCare Distributors"; model_number = "XR-900"; category = "X-Ray"; customer_name = "Manipal Hospitals Bengaluru"; installation_location = "Radiology Suite 2"; purchase_price = 420000; warranty_months = 18; created_by = $CreatedBy },
